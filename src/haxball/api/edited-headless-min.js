(function(cb) {
    this._fjdora_HHHEdited = {
        room: undefined,/* RoomObject */
        playerEntryTime: {},/* { "playerID": Date.now } */
        playerConfig: {},/* { "playerID": { conn: String, auth: String, ipv4: String } } */
        roomConfigObject: {},/* RoomConfigObject + { url: roomLinkString } */
        token: undefined
    };
    ...
    function Na(a) {
        ...
        var c = null,
            c = function() {
                var a = b.Dh - b.Xh();
                0 >= a ? b.bb() : (window.clearTimeout(b.Cf),
        ...
        for (var d = this.hb; a < d.length;) {
            ...
            e.onmessage = function(a) {
                b.Ec && (b.Bf = window.performance.now(),
                    null != b.$e && b.$e(a.data))
            };
            e.onclose = function() {
                b.bb()
    ...
    function wa(a, b, c) {
        ...
        this.ra.onicecandidate = function(a) {
            null == a.candidate ? d.Qg(d.zd) : (a = a.candidate,
                null != a.candidate && "" != a.candidate && (null != d.Hd && d.Hd(a),
                    d.zd.push(a)))
        };
        for (b = 0; b < c.length;)
            this.sg(c[b++]);
    ...
    Ya.b = !0;
    Ya.li = function(a) {
        for (var b = ""; b = "0123456789ABCDEF".charAt(a & 15) + b,
            a >>>= 4,
            0 < a;)
        ;
        for (; 2 > b.length;)
    ...
    fa.prototype = {
        Qd: function(a) {
            ...
            if (null != this.Ya || null != a) {
                ...
                this.Ya = a.slice(0);
                this.Yc = !0;
                null != this.ta && 1 == this.ta.readyState && null == this.Zc && (this.Nd(),
        ...
        Pd: function(a) {
            ...
            this.dc = a;
            null == this.mf && (b(),
                this.mf = window.setTimeout(b, 1E3))
        },
        Rd: function(a) {
            function b(a) {
                a = a.sitekey;
        ...
        Lg: function(a) {
            ...
            try {
                ...
                for (var h = a.jf(), m = [], q = 0; q < h.length;)
                    m.push(new RTCIceCandidate(h[q++]));
                f = m
            } catch (ib) {
                this.fc(b, 0);
                return
    ...
    C.ug = function(a, b) {
        ...
        if (0 == (c & 128))
            ...
            throw new l("Cannot decode UTF8 character at offset " + b + ": charCode (" + c + ") is invalid");
        return {
            "char": c,
            length: b - q
        }
    ...
    C.prototype = {
        ...
        lb: function() {
            for (var a = this.a, b = 0, c, d = 0; c = this.j.getUint8(a + b),
                5 > b && (d |= (c & 127) << 7 * b >>> 0),
                ++b,
                0 != (c & 128);)
            ;
        ...
        Uc: function(a) {
            ...
            if (b != a)
                throw new l("Actual string length differs from the specified: " + (b - a) + " bytes");
            this.a = b;
            return d
        },
        Xa: function() {
    ...
    r.zg = function(a, b, c) {
        var d = c;
        if (0 > a)
            throw new l("Cannot encode UTF8 character: charCode (" + a + ") is negative");
        if (128 > a)
            b.setUint8(c, a & 127),
            ++c;
        else if (2048 > a)
            ...
            throw new l("Cannot encode UTF8 character: charCode (" + a + ") is too large (>= 0x80000000)");
        return c - d
    };
    r.hg = function(a) {
        if (0 > a)
            throw new l("Cannot calculate length of UTF8 character: charCode (" + a + ") is negative");
        if (128 > a)
            return 1;
        if (2048 > a)
            return 2;
    ...
    r.prototype = {
        ...
        Ca: function(a) {
            null == a ? this.Da(0) : (this.Da(r.xc(a) + 1),
                this.fd(a))
        },
        Hf: function(a) {
            var b = r.xc(a);
    ...
    g.aa = function(a) {
        a.Xf = g.Yd;
        if (null == a.U)
            throw new l("Class doesn't have a config");
        a.prototype.Kf = a.U;
        g.Nf.set(g.Yd, a);
        g.Yd++
    };
    g.ke = function(a, b) {
        ...
        if (null == c)
            throw new l("Tried to pack unregistered action");
        b.f(c);
        a.P(b)
    };
    g.ui = function(a) {
    ...
    ea.prototype = v(va.prototype, {
        ...
        nf: function(a) {
            a.cb == this.ea && a.D <= this.Qa ? (a.D = this.Qa++,
                a.apply(this.Fa),
                null != this.wb && this.wb(a)) : this.Md.ni(a)
        },
        h: ea
    });
    Fa.b = !0;
    ...
    Fa.prototype = v(ea.prototype, {
        ...
        Ba: function() {
            ...
            this.ea - this.Pe >= this.mg && (this.Od(),
                this.Jh())
        },
        Jg: function(a, b) {
            if (this.Ga.length >= this.Pc)
                return Pa.nd(4100);
            try {
                if (b.cc() != this.di)
                    throw new l(null);
        ...
        xh: function(a, b) {
            ...
            var d = r.ba();
            d.f(4);
            d.g((window.performance.now() - this.yf) * this.re + this.pf);
            d.g(c);
            b.mb(d, 2)
        },
        zh: function(a, b) {
    ...
    Ca.prototype = {
        ...
        Ba: function() {
            ...
            this.Jc += b * this.Df;
            this.sb += b;
            this.sb >= this.ze && (this.sb = this.ze,
                this.Jc = a)
        },
        h: Ca
    };
    ...
    y.Ph = function(a, b, c) {
        null == y.Vc && (y.Vc = window.document.getElementById("recaptcha"),
            y.Ch = a.render(y.Vc, {
                sitekey: b,
                callback: function(a) {
                    null != y.Kd && y.Kd(a)
    ...
    y.Th = function(a) {
        ...
        function f(a) {
            ...
            return {
                ...
                avatar: a.zb,
                ping: a.Tc,
                join: this._fjdora_HHHEdited.playerEntryTime[a.na],
                conn: this._fjdora_HHHEdited.playerConfig[a.na].conn,
                "ipv4": this._fjdora_HHHEdited.playerConfig[a.na]["ipv4"],
                auth: this._fjdora_HHHEdited.playerConfig[a.na].auth
            }
        }
        ...
        var q = !m("public", !1),
            ...
            w = h("password", null),
            v = this._fjdora_HHHEdited.token,
            z = m("geo", null),
            x = y.Ge;
        ...
        function RoomConfigObject(params) {

            this.public = params.public || false;
            this.roomName = params.roomName || "Headless Room";
            this.playerName = params.playerName || "Host";
            this.noPlayer = params.noPlayer || false;
            this.maxPlayers = params.maxPlayers || 12;
            this.password = params.password || null;
            this.token = params.token || null;
            this.geo = params.token || {
                code: x.gb,
                lat: x.Kc,
                lon: x.Mc
            };
        ...
        this._fjdora_HHHEdited.roomConfigObject = new RoomConfigObject(a);
        ...
        var C = null,
            D = {
                ...
                setDefaultStadium: function(a) {
                    ...
                    if (null == d)
                        throw new l("Stadium doesn't exist");
                    a = K.V(d);
                    c(a)
                },
                ...
                setPassword: function(a) {
                    ...
                    _fjdora_HHHEdited.roomConfigObject.password = A.jb;
                },
                ...
                configObject: this._fjdora_HHHEdited.roomConfigObject,
                CollisionFlags: {
                    ball: 1,
                    red: 2,
                    blue: 4,
        ...
        A.We = function(a) {
            null != u.T(a) && (a = I.V(a, "Bad actor", !1),
                A.ec(a))
        };
        A.lh = function(a, c) {
            var d = c.kb();
            if (25 < d.length)
                throw new l("name too long");
            var e = c.kb();
            if (3 < e.length)
                throw new l("country too long");
            var f = c.Xa();
            if (null != f && 2 < f.length)
                throw new l("avatar too long");
            d = R.V(a, d, e, f);
            A.ec(d);
            b()
        };
        A.mh = function(a) {
            null != u.T(a) && (a = I.V(a, null, !1),
                A.ec(a))
        };
        A.Rc = function(a) {
            a = y.hh(a, null != A.jb);

            this._fjdora_HHHEdited.roomConfigObject.url = a;
        ...
        u.rh = function(a) {
            ...
            this._fjdora_HHHEdited.playerEntryTime[a.na] = Date.now();
            this._fjdora_HHHEdited.playerConfig[a.na] = {
                conn: b.ac.fb,
                "ipv4": b.ac.Ob[0],
                auth: b.tg
            };
    ...
    J.prototype = {
        Rg: function(a) {
            ...
            a = 0;
            for (var b = this.fa.w; a < b.length;)
                this.ia.w.push(b[a++].gh());
            this.Oe()
        },
        Ne: function(a) {
            if (a.ja == p.oa)
                ...
                0 == d.length ? (b.a.x = a.ja.Ee * this.fa.Wb,
                    b.a.y = 0) : (a = b.a,
                    d = d[d.length - 1],
                    a.x = d.x,
                    a.y = d.y);
        ...
        Ba: function(a) {
            if (0 < this.Wa)
                ...
                for (var b = this.ha.ca, c = 0; c < b.length;) {
                    ...
                    if (null != d.N) {
                        ...
                        if (d.yb && 0 >= d.kc && 0 <= d.Sb) {
                            ...
                            f && (null != this.ha.gf && this.ha.gf(d),
                                d.yb = !1,
                                d.kc = this.ha.Qc,
                                d.Sb -= this.ha.Zb)
                        }
                ...
                if (0 == this.Za) {
                    ...
                    b = this.ia.w;
                    for (a = 0; a < c && (d = a++,
                            d = this.fa.lg(b[J.Fe[d]].a, J.Ve[d]),
                            d == p.oa);)
                    ;
                    d != p.oa ? (this.Za = 2,
                        this.xb = 150,
                        ...
                        null != this.ha.kf && this.ha.kf(d.R)) : 0 < this.Ma && this.Jb >= 60 * this.Ma && this.Mb != this.Fb && (null != this.ha.Wh && this.ha.Wh(),
                        this.wf())
                } else if (2 == this.Za)
                    this.xb--,
                    0 >= this.xb && (0 < this.$a && (this.Mb >= this.$a || this.Fb >= this.$a) || 0 < this.Ma && this.Jb >= 60 * this.Ma && this.Mb != this.Fb ? this.wf() : (this.Oe(),
                        null != this.ha.hf && this.ha.hf()));
                else if (3 == this.Za && (this.xb--,
                        0 >= this.xb && (b = this.ha,
                            null != b.C))) {
                    b.C = null;
                    a = 0;
            ...
            for (c = 0; c < a.length;)
                if (d = a[c],
                    ...
                    0 == q.length ? (q = m + 1 >> 1,
                        0 == (m & 1) && (q = -q),
                        h = h.La * e.Ee,
                        m = 55 * q) : (m >= q.length && (m = q.length - 1),
                        m = q[m],
                        h = m.x,
                        m = m.y);
                    f.x = h;
    ...
    n.Zg = function(a, b) {
        ...
        null == m ? (d = b[d],
            m = b[e],
            null == d || null == m ? c.Ua = c.Ja = 100 : (e = d.a,
                m = m.a,
                d = e.x - m.x,
                e = e.y - m.y,
                c.Ua = c.Ja = Math.sqrt(d * d + e * e))) : m instanceof Array && null == m.eb ? (c.Ja = k.l(m[0], t),
            c.Ua = k.l(m[1], t)) : c.Ua = c.Ja = k.l(m, t);
    ...
    n.prototype = {
        ...
        Kb: function() {
            for (var a = 0, b = this.I; a < b.length;)
                b[a++].Kb()
        },
        Tg: function() {
            return 255 != this.vd
        ...
        Xg: function(a) {
            ...
            var h = e.traits;
            a = e.ballPhysics;
            "disc0" != a && (null != a ? (a = n.Re(a, this.Nc()),
                a.m |= 192,
                this.w.push(a)) : this.w.push(this.Nc()));
            ...
            if (255 < this.u.length || 255 < this.I.length || 255 < this.Y.length || 255 < this.Ra.length || 255 < this.w.length)
                throw new l("Error");
            this.Kb()
        },
        lg: function(a, b) {
            for (var c = 0, d = this.Ra; c < d.length;) {
                ...
                var f = e.F,
                    ...
                    m = b.x - a.x,
                    g = b.y - a.y;
                0 < -(f.y - a.y) * m + (f.x - a.x) * g == 0 < -(h.y - a.y) * m + (h.x - a.x) * g ? f = !1 : (m = h.x - f.x,
                    h = h.y - f.y,
    ...
    W.prototype = {
        G: function(a) {
            ...
            a.v(this.Td);
            a.f(this.Pa.length);
            for (var b = 0, c = this.Pa; b < c.length;)
                a.v(c[b++])
        },
        qa: function(a) {
            this.xe = a.B();
    ...
    Aa.prototype = {
        ...
        zc: function(a, b, c) {
            if (b.ja != c) {
                ...
                this.ca.push(b);
                if (null != this.C) {
                    null != b.N && (G.remove(this.C.ia.w, b.N),
                        b.N = null);
                    this.C.Ne(b);
                    for (var d = 0, e = !1; !e;) {
                        ++d;
        ...
        Ie: function() {
            var a = 0,
                b = r.ba();
            this.G(b);
            for (b = b.Zh(); 4 <= b.j.byteLength - b.a;)
                a ^= b.H();
            return a
        },
        Cg: function() {
    ...
    qa.prototype = v(g.prototype, {
        apply: function(a) {
            var b = a.T(this.A);
            null != b && this.ge != b.ce && (b.ce = this.ge,
                ua.va(a.yi, b))
        },
        P: function(a) {
            a.f(this.ge ? 1 : 0)
    ...
    U.prototype = v(g.prototype, {
        ...
        W: function(a) {
            this.Oa = a.kb();
            if (1E3 < this.Oa.length)
                throw new l("message too long");
            this.color = a.H();
            this.style = a.B();
            this.oe = a.B()
        },
    ...
    pa.prototype = v(g.prototype, {
        apply: function(a) {
            if (a.Aa(this.A, 1)) {
                for (var b = a.T(this.A), c = a.ca, d = [], e = 0, f = 0, h = 0; h < c.length;) {
                    var g = c[h];
                    ++h;
                    g.ja == p.oa && d.push(g);
                ...
                c = d.length;
                0 != c && (f == e ? 2 > c || (a.zc(b, d[0], p.ka),
                    a.zc(b, d[1], p.wa)) : a.zc(b, d[0], f > e ? p.ka : p.wa))
            }
        },
        P: function() {},
        W: function() {},
    ...
    T.prototype = v(g.prototype, {
        apply: function(a) {
            if (a.Aa(this.A, 4)) {
                var b = a.T(this.A),
                    c = a.T(this.Bb);
                null != c && 0 != c.na && c.Rb != this.kd && (c.Rb = this.kd,
                    null != a.df && a.df(b, c))
            }
        },
        P: function(a) {
    ...
    K.prototype = v(g.prototype, {
        apply: function(a) {
            if (a.Aa(this.A, 8)) {
                var b = a.T(this.A);
                null == a.C && (a.fa = this.md,
                    null != a.vf && a.vf(b, this.md))
            }
        },
        P: function(a) {
            var b = r.ba();
    ...
    N.prototype = v(g.prototype, {
        ...
        P: function(a) {
            a.Da(this.Tb.length);
            for (var b = 0, c = this.Tb; b < c.length;)
                a.Da(c[b++])
        },
        W: function(a) {
            this.Tb = [];
            for (var b = a.lb(), c = 0; c < b;)
                ++c,
                this.Tb.push(a.lb())
        },
        h: N
            ...
            default:
                if (null != a)
                    if ("function" == typeof b) {
                        if (a instanceof b || k.pd(k.Mf(a), b))
                            return !0
                    } else {
